...
public class GeoSuggestSteps {
	...
	Map<String, String> serviceCookies = new LinkedHashMap<String, String>();
	...
	public void send_the_geo_suggest_service_request_without_cookies() throws Throwable {
		response = SendRequest.sendGetRequest(PropertyHelper.getProperty("geo_suggest_service"), headers, queryParams,
				serviceCookies);
